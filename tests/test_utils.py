...
#     file2 = utils.LoadSingleReader(
#         os.path.join(vcfdir, "test_gangstr.vcf"), checkgz=False
#     )
#     assert file2 is not None
#     file3 = utils.LoadSingleReader(
#         os.path.join(vcfdir, "nonexistent.vcf"), checkgz=False
#     )
...
#     afreqs = {0: 0.5, 1: 0.2, 2: 0.3}
#     assert abs(utils.GetEntropy(afreqs) - 1.48) < 0.01
#     afreqs = {}
