...
See `tests/data/simple.pheno <https://github.com/gymrek-lab/core/blob/main/tests/data/simple.pheno>`_ for an example of a phenotype file:
...
See `tests/data/simple.covar <https://github.com/gymrek-lab/core/blob/main/tests/data/simple.covar>`_ for an example of a covariate file:
